...
enum AppLinks {
    ...
    static let geminiUsageDocs = url(for: "https://ai.google.dev/gemini-api/docs")
    ...
    static let geminiAdminDocs = url(for: "https://ai.google.dev/gemini-api/docs/billing")
    ...
    static let cursorUsage = url(for: "https://cursor.com/dashboard/spending")
    static let openRouterCredits = url(for: "https://openrouter.ai/credits")
    static let geminiUsage = url(for: "https://aistudio.google.com/")
